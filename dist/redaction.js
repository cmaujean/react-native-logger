...
exports.redactValue = exports.redactSensitiveInfo = void 0;
 ...
 */
function redactSensitiveInfo(input) {
    let result = input;
...
function redactValue(value) {
    ...
    if (typeof value === 'object' && value.constructor === Object) {
        ...
        for (const key of Object.keys(value)) {
            ...
            if (SENSITIVE_FIELD_NAMES.some(sensitiveKey => key.toLowerCase().includes(sensitiveKey)) &&
